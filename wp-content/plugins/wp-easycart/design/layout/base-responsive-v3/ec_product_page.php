...
<input type="hidden" id="wp_easycart_cart_id" value="<?php if( $GLOBALS['ec_cart_id'] == 'not-set' ){ wpeasycart_session( )->handle_session( ); } echo $GLOBALS['ec_cart_id']; ?>" />
...
<section class="ec_product_page" id="ec_product_page">
	<?php if( $this->has_products( ) ){ ?>
   	<div class="ec_product_page_sort">
        ...
        if( $admin_access ){ ?>
        <div class="ec_product_admin_reorder_button_holder"><a href="http://v3docs.wpeasycart.com/3.0.0/index/known_issues.php?jqueryissue=true" target="_blank" class="ec_product_admin_reorder_button" onclick="ec_admin_sort_products_open_click( ); return false;">set default sort order</a></div>
        <?php }?>

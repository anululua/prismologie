...
<section class="ec_cart_page">
    ...
    <div class="ec_cart_right">
        ...
        <div class="ec_cart_success_message" id="ec_coupon_success"<?php if( isset( $this->coupon ) ){?> style="display:block;"<?php }?>><?php if( isset( $this->coupon ) ){ echo $GLOBALS['language']->convert_text( $this->coupon->message ); } ?></div>

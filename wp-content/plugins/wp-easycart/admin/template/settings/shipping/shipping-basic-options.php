<div class="ec_admin_list_line_item">
    ...
    <div class="ec_admin_settings_input ec_admin_settings_live_payment_section">
        ...
        <div><input type="checkbox" name="ec_option_add_local_pickup" id="ec_option_add_local_pickup" value="1"<?php if( get_option('ec_option_add_local_pickup') == "1" ){ echo " checked=\"checked\""; }?> /> Add Free Local Pickup (Weight, Price, Quantity, and Percentage Methods)</div>

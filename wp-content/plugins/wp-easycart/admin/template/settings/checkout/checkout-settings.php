<div class="ec_admin_list_line_item ec_admin_demo_data_line">
    ...
    <div class="ec_admin_settings_input ec_admin_settings_live_payment_section">
        ...
        <div><input type="checkbox" name="ec_option_skip_cart_login" id="ec_option_skip_cart_login" value="1"<?php if( get_option('ec_option_skip_cart_login') == "1" ){ echo " checked=\"checked\""; }?> /> Skip Login Screen in Cart</div>

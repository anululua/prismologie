<?php
class wp_easycart_admin_store_status{
...
////////////////////////////////////////////////
	...
	public function ec_ups_shipping_setup( ){
		...
		if( $setting_row->ups_access_license_number && $setting_row->ups_user_id && $setting_row->ups_password && $setting_row->ups_ship_from_zip && $setting_row->ups_shipper_number && $setting_row->ups_country_code && $setting_row->ups_weight_type ){
			...
			$ups_response = $ups_class->get_rate_test( "01", $setting_row->ups_ship_from_zip, $setting_row->ups_country_code, "1", 0, 0, 0, 0, array( (object) array( 'quantity' => 1, 'weight' => 1, 'width' => 1, 'length' => 1, 'height' => 1 ) ) );
	...
	public function ec_usps_shipping_setup( ){
		...
		if( $setting_row->usps_user_name && $setting_row->usps_ship_from_zip ){
			...
			$usps_response = $usps_class->get_rate_test( "PRIORITY", $setting_row->usps_ship_from_zip, "US", "1", 0, 0, 0, 0, array( (object) array( 'quantity' => 1, 'weight' => 1, 'width' => 1, 'length' => 1, 'height' => 1 ) ) );

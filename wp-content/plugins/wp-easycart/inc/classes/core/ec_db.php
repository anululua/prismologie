...
class ec_db{
	...
	public static function insert_subscriber( $email, $first_name, $last_name ){
		...
		self::$mysqli->insert( 'ec_subscriber',
								array(	"email"			=> $email,
										"first_name"	=> $first_name,
										"last_name"		=> $last_name ),
								array( '%s', '%s', '%s' )
	...
	public static function insert_order_option( $orderdetail_id, $tempcart_id, $advanced_option ){
		$sql = "INSERT INTO ec_order_option(orderdetail_id, option_name, optionitem_name, option_type, option_value, option_price_change, optionitem_allow_download, option_label, option_to_product_id, option_order) VALUES(%d, %s, %s, %s, %s, %s, %d, %s, %d, %d)";
		...
		self::$mysqli->query( self::$mysqli->prepare( $sql, $orderdetail_id, $advanced_option->option_name, $advanced_option->optionitem_name, $advanced_option->option_type, $option_value, $optionitem_price, $advanced_option->optionitem_allow_download, $advanced_option->option_label, $advanced_option->option_to_product_id, $advanced_option->option_order ) );
	}
	
	public static function insert_response( $order_id, $is_error, $processor, $response_text ){
		if( get_option( 'ec_option_enable_gateway_log' ) ){
			self::$mysqli->insert( 	'ec_response',
								array( 	'order_id' => $order_id,
										'is_error' => $is_error,
										'processor' => $processor,
	...
	public static function get_advanced_optionsets( $product_id ){
		...
		if( !$optionsets ){
			$sql = "SELECT ec_option.option_id, ec_option.option_name, ec_option.option_label, ec_option.option_type, ec_option.option_required, ec_option.option_error_text, ec_option.option_meta FROM ec_option_to_product LEFT JOIN ec_option ON ec_option.option_id = ec_option_to_product.option_id WHERE ec_option_to_product.product_id = %d AND ec_option.option_id != '' ORDER BY ec_option_to_product.option_to_product_id ASC";
	...
	public static function insert_subscription_order( $product, $user, $card, $subscription_id, $coupon_code, $order_notes, $option1_name, $option2_name, $option3_name, $option4_name, $option5_name, $option1_label, $option2_label, $option3_label, $option4_label, $option5_label, $quantity, $order_totals, $shipping_method, $tax, $discount_total ){
		...
		self::$mysqli->query( self::$mysqli->prepare( $sql, 
				...
				$user->billing->address_line_2, $user->shipping->address_line_2 
		) );
	...
	public static function update_stripe_subscription( $subscription_id, $webhook_data ){
		...
		self::$mysqli->query( self::$mysqli->prepare( $sql, $webhook_data->lines->data[0]->plan->name, ( $webhook_data->lines->data[0]->plan->amount /100 ), $webhook_data->lines->data[0]->plan->interval_count, self::get_stripe_subscription_period( $webhook_data->lines->data[0]->plan->interval ), $webhook_data->period_start, $webhook_data->period_end, $subscription_id ) );
	}
	...
	public static function get_option_quantity_values( $product_id ){
		...
		return self::$mysqli->get_results( self::$mysqli->prepare( "SELECT ec_optionitem.optionitem_id, SUM( ec_optionitemquantity.quantity ) as quantity FROM ec_optionitemquantity LEFT JOIN ec_optionitem ON ( ec_optionitemquantity.optionitem_id_1 = ec_optionitem.optionitem_id ) WHERE ec_optionitemquantity.product_id = %d AND ec_optionitem.optionitem_id = ec_optionitemquantity.optionitem_id_1 GROUP BY ec_optionitemquantity.optionitem_id_1 ORDER By ec_optionitem.optionitem_order", $product_id ) );
		
	}
	
	public static function get_option2_quantity_values( $product_id, $optionitem_id_1 ){
	
		return self::$mysqli->get_results( self::$mysqli->prepare( "SELECT ec_optionitem.optionitem_id, SUM( ec_optionitemquantity.quantity ) as quantity FROM ec_optionitemquantity LEFT JOIN ec_optionitem ON ( ec_optionitemquantity.optionitem_id_2 = ec_optionitem.optionitem_id ) WHERE ec_optionitemquantity.product_id = %d AND ec_optionitemquantity.optionitem_id_1 = %d AND ec_optionitem.optionitem_id = ec_optionitemquantity.optionitem_id_2 GROUP BY ec_optionitemquantity.optionitem_id_1, ec_optionitemquantity.optionitem_id_2 ORDER By ec_optionitem.optionitem_order", $product_id, $optionitem_id_1 ) );
		
	}
	
	public static function get_option3_quantity_values( $product_id, $optionitem_id_1, $optionitem_id_2 ){
	
		return self::$mysqli->get_results( self::$mysqli->prepare( "SELECT ec_optionitem.optionitem_id, SUM( ec_optionitemquantity.quantity ) as quantity FROM ec_optionitemquantity LEFT JOIN ec_optionitem ON ( ec_optionitemquantity.optionitem_id_3 = ec_optionitem.optionitem_id ) WHERE ec_optionitemquantity.product_id = %d AND ec_optionitemquantity.optionitem_id_1 = %d AND ec_optionitemquantity.optionitem_id_2 = %d AND ec_optionitem.optionitem_id = ec_optionitemquantity.optionitem_id_3 GROUP BY ec_optionitemquantity.optionitem_id_1, ec_optionitemquantity.optionitem_id_2, ec_optionitemquantity.optionitem_id_3 ORDER By ec_optionitem.optionitem_order", $product_id, $optionitem_id_1, $optionitem_id_2 ) );
		
	}
	
	public static function get_option4_quantity_values( $product_id, $optionitem_id_1, $optionitem_id_2, $optionitem_id_3 ){
	
		return self::$mysqli->get_results( self::$mysqli->prepare( "SELECT ec_optionitem.optionitem_id, SUM( ec_optionitemquantity.quantity ) as quantity FROM ec_optionitemquantity LEFT JOIN ec_optionitem ON ( ec_optionitemquantity.optionitem_id_4 = ec_optionitem.optionitem_id ) WHERE ec_optionitemquantity.product_id = %d AND ec_optionitemquantity.optionitem_id_1 = %d AND ec_optionitemquantity.optionitem_id_2 = %d AND ec_optionitemquantity.optionitem_id_3 = %d AND ec_optionitem.optionitem_id = ec_optionitemquantity.optionitem_id_4 GROUP BY ec_optionitemquantity.optionitem_id_1, ec_optionitemquantity.optionitem_id_2, ec_optionitemquantity.optionitem_id_3, ec_optionitemquantity.optionitem_id_4 ORDER By ec_optionitem.optionitem_order", $product_id, $optionitem_id_1, $optionitem_id_2, $optionitem_id_3 ) );
	...
	public static function get_option5_quantity_values( $product_id, $optionitem_id_1, $optionitem_id_2, $optionitem_id_3, $optionitem_id_4 ){
		...
		return self::$mysqli->get_results( self::$mysqli->prepare( "SELECT ec_optionitem.optionitem_id, SUM( ec_optionitemquantity.quantity ) as quantity FROM ec_optionitemquantity LEFT JOIN ec_optionitem ON ( ec_optionitemquantity.optionitem_id_5 = ec_optionitem.optionitem_id ) WHERE ec_optionitemquantity.product_id = %d AND ec_optionitemquantity.optionitem_id_1 = %d AND ec_optionitemquantity.optionitem_id_2 = %d AND ec_optionitemquantity.optionitem_id_3 = %d AND ec_optionitemquantity.optionitem_id_4 = %d AND ec_optionitem.optionitem_id = ec_optionitemquantity.optionitem_id_5 GROUP BY ec_optionitemquantity.optionitem_id_1, ec_optionitemquantity.optionitem_id_2, ec_optionitemquantity.optionitem_id_3, ec_optionitemquantity.optionitem_id_4, ec_optionitemquantity.optionitem_id_5 ORDER By ec_optionitem.optionitem_order", $product_id, $optionitem_id_1, $optionitem_id_2, $optionitem_id_3, $optionitem_id_4 ) );
	...
	public static function get_download_list( $user_id ){
		return self::$mysqli->get_results( self::$mysqli->prepare( "SELECT ec_orderdetail.*, ec_download.download_count FROM ec_orderdetail LEFT JOIN ec_download ON ec_download.download_id = ec_orderdetail.download_key, ec_order, ec_orderstatus WHERE ec_order.order_id = ec_orderdetail.order_id AND ec_order.user_id = %d AND ec_orderstatus.status_id = ec_order.orderstatus_id AND ec_orderstatus.is_approved = 1 AND ec_orderdetail.is_download = 1 ORDER BY ec_orderdetail.title ASC", $user_id ) );
	}

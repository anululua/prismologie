...
class ec_cartitem{
	...
	function __construct( $cartitem_data ){
		...
		$this->converted_total_price = ( $GLOBALS['currency']->convert_price( $this->unit_price ) * $this->quantity ) + $GLOBALS['currency']->convert_price( $options_price_onetime ) + $GLOBALS['currency']->convert_price( $grid_price_change );
